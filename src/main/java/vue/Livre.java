 ...
 * @author Lucah
 */
public final class Livre extends javax.swing.JInternalFrame {
    ...
    public void remplir(JTable table){
        ...
        model.setRowCount(0);
        Object[]row;
        for(modele.Livre livre:list){
            row = new Object[5];
            row[0] = livre.getId();
            row[1] = livre.getTitre();
            row[2] = livre.getAuteur();
            row[3] = livre.getAnnee();
            row[4] = livre.getGenre();

            model.addRow(row);
        }
    }
    
    public void remplirAuteur(JTable table){
        List<modele.Livre> list = livreController.rechercherAuteur(recherche.getText());
        DefaultTableModel model = (DefaultTableModel)table.getModel();
        model.setRowCount(0);
        Object[]row;
        for(modele.Livre livre:list){
     ...
     public void remplirGenre(JTable table){
        List<modele.Livre> list = livreController.rechercherGenre(recherche.getText());
        DefaultTableModel model = (DefaultTableModel)table.getModel();
        model.setRowCount(0);
        Object[]row;
        for(modele.Livre livre:list){
     ...
     public void remplirAnnee(JTable table){
        List<modele.Livre> list = livreController.rechercherAnnee(recherche.getText());
        DefaultTableModel model = (DefaultTableModel)table.getModel();
        model.setRowCount(0);
        Object[]row;
        for(modele.Livre livre:list){
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Ajout d'un nouveau livre");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(titre, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(auteur, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(genre, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(annee, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel7.setText("Chercher par:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Auteur", "Genre", "Année" }));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(recherche, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        if(jButton2.getText() == "Ajouter"){
            ...
            String genreValue = genre.getText();


            if(titreValue.isEmpty() || auteurValue.isEmpty() || anneeValue.isEmpty() || genreValue.isEmpty() ){
                JOptionPane.showMessageDialog(null,"Veuillez compléter le champ","Attention",JOptionPane.WARNING_MESSAGE);
            }
            else{
                modele.Livre livre = new modele.Livre();
                livre.setTitre(titreValue);
                livre.setAuteur(auteurValue);
                livre.setAnnee(anneeValue);
                livre.setGenre(genreValue);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if(table.isRowSelected(itemSelected)){
            ...
            titre.setText(String.valueOf(table.getValueAt(table.getSelectedRow(),1)));
            auteur.setText(String.valueOf(table.getValueAt(table.getSelectedRow(),2)));
            annee.setText(String.valueOf(table.getValueAt(table.getSelectedRow(),3)));
            genre.setText(String.valueOf(table.getValueAt(table.getSelectedRow(),4)));
            
            jLabel6.setText("Edition d'un livre");
    ...
    private void jToggleButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jToggleButton1MouseClicked
        ...
        if(table.isRowSelected(itemSelected)){
            ...
            int reponse = JOptionPane.showConfirmDialog(this,"Voulez-vous vraiment supprimer ce livre ?",  "Confirmation",JOptionPane.YES_NO_OPTION);
            if(reponse == JOptionPane.YES_OPTION){
                livreController.supprimerLivre(num);
                remplir(table);
    ...
    private void rechercheKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_rechercheKeyReleased
        ...
        if (search.equals("")) {
            ...
            if(jComboBox1.getSelectedItem() == "Auteur"){
                remplirAuteur(table);
            }
            else if(jComboBox1.getSelectedItem() == "Genre"){
                remplirGenre(table);
            }
            else if(jComboBox1.getSelectedItem() == "Année"){
                remplirAnnee(table);
            }
        } 
